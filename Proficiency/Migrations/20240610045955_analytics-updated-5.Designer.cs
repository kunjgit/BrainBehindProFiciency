...
namespace Proficiency.Migrations
{
    ...
    [Migration("20240610045955_analytics-updated-5")]
    partial class analyticsupdated5
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Proficiency.Models.ProfWiseAnalytics", b =>
                {
                    ...
                    b.Property<int?>("StudentWiseAnalyticsId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StudentWiseAnalyticsId");
            ...
            modelBuilder.Entity("Proficiency.Models.StudentWiseAnalytics", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("StudentWiseAnalytics");
                });
            ...
            modelBuilder.Entity("Proficiency.Models.ProfWiseAnalytics", b =>
                {
                    ...
                    b.HasOne("Proficiency.Models.StudentWiseAnalytics", null)
                        .WithMany("Profwise")
                        .HasForeignKey("StudentWiseAnalyticsId");
                });
